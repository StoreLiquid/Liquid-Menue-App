...
export default function Home() {
  ...
  return (
    <div className="min-h-screen relative overflow-y-auto overflow-x-hidden text-white">
      ...
      <div className="fixed inset-0 w-screen h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-black animate-gradient-slow"></div>
      
      {/* Subtiles Muster-Overlay für mehr Tiefe */}
      <div className="fixed inset-0 w-screen h-screen opacity-10 bg-[url('/noise-pattern.svg')] mix-blend-overlay"></div>
      
      {/* Glanzeffekt am oberen Rand */}
      <div className="fixed top-0 left-0 right-0 h-[1px] w-full bg-gradient-to-r from-transparent via-gray-400 to-transparent animate-pulse-light"></div>
